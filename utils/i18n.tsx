...
const translations = {
  [Language.EN]: {
    ...
    getKey: 'Get Key',
    geminiKeyGuide: 'Visit Google AI Studio to create a free API key for Gemini models.',
    deepseekKeyGuide: 'Visit DeepSeek platform to create an API key for DeepSeek models.',
    customAIGuide: 'Enter any OpenAI-compatible API endpoint. Supports GPT, Claude, and other models.',
    customAIFormat: 'OpenAI Compatible',
  ...
  [Language.ZH_CN]: {
    ...
    customApiKey: 'API Key',
    customModel: '模型名称',
    apiKeyGuide: 'API Key 获取指南',
    getKey: '获取 Key',
    geminiKeyGuide: '访问 Google AI Studio 创建免费的 Gemini API Key。',
    deepseekKeyGuide: '访问 DeepSeek 平台创建 API Key。',
    customAIGuide: '输入任意 OpenAI 兼容的 API 端点，支持 GPT、Claude 等模型。',
    customAIFormat: 'OpenAI 兼容格式',
  ...
  [Language.JA]: {
    ...
    customApiKey: 'API Key',
    customModel: 'モデル名',
    apiKeyGuide: 'API Key ガイド',
    getKey: 'Key取得',
    geminiKeyGuide: 'Google AI Studio で無料の Gemini API Key を作成できます。',
    deepseekKeyGuide: 'DeepSeek プラットフォームで API Key を作成できます。',
    customAIGuide: 'OpenAI 互換の API エンドポイントを入力。GPT、Claude などのモデルに対応。',
    customAIFormat: 'OpenAI 互換',
  ...
  [Language.ES]: {
    ...
    customAI: 'Personalizado',
    customApiUrl: 'URL de API',
    customApiKey: 'API Key',
    customModel: 'Nombre del Modelo',
    apiKeyGuide: 'Guía de API Key',
    getKey: 'Obtener Key',
    geminiKeyGuide: 'Visita Google AI Studio para crear una API Key gratuita para Gemini.',
    deepseekKeyGuide: 'Visita la plataforma DeepSeek para crear una API Key.',
    customAIGuide: 'Ingresa cualquier endpoint API compatible con OpenAI. Soporta GPT, Claude y otros modelos.',
    customAIFormat: 'Compatible OpenAI',
