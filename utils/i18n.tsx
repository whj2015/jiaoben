...
const translations = {
  [Language.EN]: {
    ...
    confirmClearHistory: 'Are you sure you want to clear all history for this script?',
  ...
  [Language.ZH_CN]: {
    ...
    clearHistory: '清空历史',
    confirmClearHistory: '确定要清空此脚本的所有历史记录吗？',
    onlyChanges: '仅显示差异',
    linesHidden: '隐藏了 {{count}} 行',
    showAll: '展开',
  ...
  [Language.JA]: {
    ...
    clearHistory: '履歴をクリア',
    confirmClearHistory: 'このスクリプトの履歴をすべて削除してもよろしいですか？',
    onlyChanges: '変更のみ表示',
  ...
  [Language.ES]: {
    ...
    confirmClearHistory: '¿Estás seguro de que quieres borrar todo el historial de este script?',
    onlyChanges: 'Solo Cambios',
    linesHidden: '{{count}} líneas ocultas',
